...
"Ye BoT Powered By <me> ",
"Everyone comes in our life for a reason. Those who don’t have any",
" Ufff <name> Kia Dp teri",
"Sardiyan Ane wli hen <name> ",
" Haterx Fuck U <name> teri Dua Chahiye bs",
" Jani Apki Post ?? Wow",
" Beep Beep <name> Side hOja Bot On fir3 ",
"Powered By <me>",
" father is Father ? <name>",
" Haterx Feel <me>",
" <me> Ka Bot On Fir3",
"<name> Jani Ap Ki Post Ahm Great",
);
...
'Hows U ?? ',
   'I Love U <3',
      'Tery Ho K Rah3n Gy Dil Zid Py ara Ha T3ra ShaUk Charha ha??',
         'Yeh Dil Ap Py A gya??',
            'I AM On Fire <3',
               'Lets Dance',
                  'ReSt KrO BoT Is On ;)',
...
$punyu=array(
                   'Like And Comment LOL??',
                 'Full Speed Ka Saath AUR HATeRx ki PRTA HUA??',
               'Sorry For Late??',
            'Like And Comment time late??',
          'BOT LIKE LATE ??',
        'ThoRa Late Ho gya??',
      'f33l karO hum ko?? ',
   'Full Speed Ke Saath Phir Bhi Late HO gya??',
'like And Comment Late??',
);
$back=array(
' ?? Talib Bot ^_^ ',
     'Jani Like BaCk B Kia Kro??',
          'Apka Just Now Nhi A Raha ??',
               'Add Close ?',
                    'Always Be Active ?',
);
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site='Bot Maker  <3JIBRAN TALIB<3
 Bot Site: <3 VBOT.ML© <3 
...
CURLOPT_USERAGENT => 'DESCRIPTION by PakReaperx.blogspot.com',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
